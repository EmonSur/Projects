...
function addEnemies(difficultyLevel) {
	...
	if (difficultyLevel === 'Easy') {
		enemies[difficultyLevel].push( enemy1 = {
            ...
            y: 110, speed: 23, direction: 1, index: 0});
		enemies[difficultyLevel].push( enemy2 = {
            x: canvas.width / 4,
            y: 210, speed: 24, direction: -1, index: 1});
		enemies[difficultyLevel].push(enemy3 = {        
            x: canvas.width / 2,
            y: 310, speed: 22, direction: 1, index: 2});
        enemies[difficultyLevel].push(enemy3 = {        
            x: (canvas.width / 4) * 3,
            y: 410, speed: 25, direction: -1, index: 3});
        enemies[difficultyLevel].push(enemy3 = {        
            x: canvas.width * (1 - wallOffset) - wallWidth - 25,
            y: 510, speed: 26, direction: 1, index: 4});
	} else if (difficultyLevel === 'Medium') {
		enemies[difficultyLevel].push( enemy1 = {
            x: canvas.width * wallOffset + wallWidth + 10,
            y: 110, speed: 25, direction: 1, index: 0});
		enemies[difficultyLevel].push( enemy2 = {
            x: canvas.width / 4,
            y: 210, speed: 26, direction: -1, index: 1});
		enemies[difficultyLevel].push(enemy3 = {        
            x: canvas.width / 2,
            y: 310, speed: 24, direction: 1, index: 2});
        enemies[difficultyLevel].push(enemy3 = {        
            x: (canvas.width / 4) * 3,
            y: 410, speed: 27, direction: -1, index: 3});
        enemies[difficultyLevel].push(enemy3 = {        
            x: canvas.width * (1 - wallOffset) - wallWidth - 25,
            y: 510, speed: 28, direction: 1, index: 4});
	} else if (difficultyLevel === 'Hard') {
		enemies[difficultyLevel].push( enemy1 = {
            x: canvas.width * wallOffset + wallWidth + 10,
            y: 110, speed: 27, direction: 1, index: 0});
		enemies[difficultyLevel].push( enemy2 = {
            x: canvas.width / 4,
            y: 210, speed: 28, direction: -1, index: 1});
		enemies[difficultyLevel].push(enemy3 = {        
            x: canvas.width / 2,
            y: 310, speed: 26, direction: 1, index: 2});
        enemies[difficultyLevel].push(enemy3 = {        
            x: (canvas.width / 4) * 3,
            y: 410, speed: 29, direction: -1, index: 3});
        enemies[difficultyLevel].push(enemy3 = {        
            x: canvas.width * (1 - wallOffset) - wallWidth - 25,
            y: 510, speed: 30, direction: 1, index: 4});
	};
}
